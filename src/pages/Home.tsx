    ...
    return (
        <section className="bg-background relative flex min-h-screen items-center justify-center overflow-hidden">
            ...
            >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-bl from-cyan-500/10 to-gray-100 dark:from-amber-500/10 dark:to-gray-900" />
            </motion.div>
                        ...
                        >
                            ...
                            >
                                <motion.div
                                    ...
                                    className="shadow-elegant-lg h-72 w-52 overflow-hidden rounded-2xl sm:h-80 sm:w-64 md:h-96 md:w-80 lg:h-[28rem] lg:w-[22rem]"
                                >
                                    <img
                                        src={Profile}
